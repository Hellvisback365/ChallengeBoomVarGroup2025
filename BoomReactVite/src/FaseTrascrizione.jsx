...
const N8N_URL = "https://example-n8n-instance.com/webhook/YOUR_TRANSCRIPTION_WEBHOOK_TOKEN_HERE";
...
export default function FaseTrascrizione() {
  ...
  formData.append('companyName', nomeAzienda.toUpperCase());
      ...
      if (text === "La consulenza non esiste, hai effettuato una trascrizione di una consulenza ancora non documentata?") {
        ...
        setUploadStatus(
          "Trascrizione inserita! Trovi la tua trascrizione in https://drive.google.com/drive/folders/YOUR_GOOGLE_DRIVE_FOLDER_ID_HERE?usp=drive_link, nella cartella apposita!"
        );
      } else {
